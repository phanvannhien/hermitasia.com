...
if( get_option( 'wpgmp_api_key' ) == '' ) {
	...
	'desc' => __( 'Your google maps api key is missing. Please create it first.', WPGMP_TEXT_DOMAIN ),
	'required' => true,
...
jQuery(document).ready(function($) {
	mapData = <?php echo wp_json_encode( $map_data ); ?>
	var map = $("#wpgmp_map").maps(mapData).data('wpgmp_maps');
});
</script>
